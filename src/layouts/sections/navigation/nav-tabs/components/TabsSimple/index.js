...
import { Container, Grid, AppBar, TextField, Card, Typography, CircularProgress } from "@mui/material";
                ...
                {offers.map((offer) => (
                  <Grid item xs={12} md={6} lg={4} key={offer.id}>
                    <Card sx={{ p: 2 }} onClick={() => handleCardClick(offer.id)}>
                      ...
                      <Typography variant="body2">
                        <strong>Type de contrat :</strong> {offer.contract}
                      </Typography>
                      <Typography variant="body2">
                      ...
                      <Typography variant="body2">
                        <strong>Nombre de candidats :</strong> {offer.candidate ? offer.candidate.length : 0}
                      </Typography>
                    </Card>
                  </Grid>
                ))}
